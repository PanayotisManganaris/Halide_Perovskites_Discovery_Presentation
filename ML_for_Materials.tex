...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5a482ca}]{Inverse Design}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgd1c7839}]{OLS weights}
\begin{columns}
...
\begin{frame}[label={sec:org5178e6b}]{elasticnet weights}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\begin{tabular}{llr}
