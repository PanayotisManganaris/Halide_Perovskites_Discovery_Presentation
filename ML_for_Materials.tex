...
\label{sec:org6410a51}
\begin{frame}[label={sec:orgdd7baa4}]{Artificial Intelligence}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{org64d26db}\cite{russell-2010-artif}}
\end{block}
\end{frame}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2c00dca}]{Inverse Design}
...
\label{sec:org63a54a8}
\begin{frame}[label={sec:org9e2de38}]{Perovskite Structure and Chemistry}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org55d9574}]{Our Dataset}
\begin{columns}
...
\end{frame}
\section{Pipeline}
\label{sec:org1cb9308}
\begin{frame}[label={sec:org1681525}]{Data Pre-Processing}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org7ff007d}]{Machine Learning Pipeline}
\begin{figure}[htbp]
\centering
...
\label{sec:org9279c31}
\begin{frame}[label={sec:orgffa6d99}]{PCA}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgf24e0e3}]{tSNE}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgdabc1e2}]{UMAP}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org59faa31}]{elasticnet weights}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\begin{tabular}{llr}
