...
\label{sec:org16b963f}
\begin{frame}[label={sec:org711ad2f}]{Artificial Intelligence}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{org4f390e5}\cite{russell-2010-artif}}
\end{block}
\end{frame}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org39b3fc2}]{Inverse Design}
...
\label{sec:org9cfed53}
\begin{frame}[label={sec:org8b10dd3}]{Perovskite Structure and Chemistry}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf15de3e}]{Our Dataset}
\begin{columns}
...
\end{frame}
\section{Pipeline}
\label{sec:org8798572}
\begin{frame}[label={sec:org2257953}]{Data Pre-Processing}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org1ebb15c}]{Machine Learning Pipeline}
\begin{figure}[htbp]
\centering
...
\label{sec:orgdeb2d5a}
\begin{frame}[label={sec:org74a2901}]{PCA}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1ae1622}]{tSNE}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgb8792b6}]{UMAP}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgf4aaa14}]{OLS weights}
\begin{columns}
...
\begin{frame}[label={sec:org7a2478b}]{elasticnet weights}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
\begin{tabular}{llr}
