...
:END:
#+latex: \tiny
#+CAPTION: Scikit-Learn mock-setup and pandas data loading + grouping
#+attr_latex: :engraved-theme t
...
#+CAPTION: Computing Features with cmcl and Feature Engineering
#+attr_latex: :engraved-theme t
#+begin_src python :export code :eval never-export :tangle ./pretty_pipeline.py
  dc = df.ft.comp()
...
#+CAPTION: make Test/Train Split, Assemble, and Fit pipeline
#+attr_latex: :engraved-theme t
#+begin_src python :export code :eval never-export :tangle ./pretty_pipeline.py
...
#+CAPTION: Evaluate Pipeline using Spyglass
#+attr_latex: :engraved-theme t
#+begin_src python :export code :eval never-export :tangle ./pretty_pipeline.py
...
** Linear regressions BG Test                                      :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:BEAMER_opt: allowframebreaks
:END:
...
file:rfr_c_bg.png
** RFR Feature Importance                                          :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
** COMMENT SISSO                                                   :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
*** Analogy to Non-Dimensional Analysis
** COMMENT Sparsified Selection                                    :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
...
| A_rmse    | -0.793173 |  -0.793173 | -0.143580 |     |
| B_rmse    | -0.720543 |  -0.720543 | -0.311177 |     |
| X_rmse    | -0.703632 |  -0.703632 | -0.130350 |     |
| Pure_rmse | -0.849593 |  -0.849593 | -0.147384 |     |
* 
[[printbibliography:]]
* Footnotes
